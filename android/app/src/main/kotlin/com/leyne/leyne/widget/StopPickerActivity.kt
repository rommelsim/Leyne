// StopPickerActivity — widget configuration activity for the Saved Stop widget.
//
// Standard AppWidget configuration contract (same as FavPickerActivity):
...
//   3. Present the list of saved (pinned) stops in an AlertDialog.

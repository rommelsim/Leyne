// GlanceAppWidgetReceiver for the Saved Stop widget.
//
// Responsibilities:
...
// KEEP policy in WidgetRefreshWorker.enqueue() makes redundant enqueues (e.g.
// alongside LeyneFavServiceWidgetReceiver) safe.

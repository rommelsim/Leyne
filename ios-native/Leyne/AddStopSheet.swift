    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            if m.showAdd {
                ...
                // The sheet itself adopts Liquid Glass on iOS 26 so it
                // reads as a system-vocabulary panel rather than a flat
                // cream rectangle on the dim. Older iOS falls back to the
                // page-bg tone the design was originally built around.
